(function(g,
    ...
    g.Elastislide.prototype = {
        ...
        _layout: function() {
            ...
            this._setItemsSize();
            this.options.orientation === "horizontal" ? this.$el.css("max-height",
                this.imgSize.height) : this.$el.css("height",
        ...
        _addControls: function() {
            ...
            this.$navNext = this.$navigation.find("span.elastislide-next").on("mousedown.elastislide",
                function(l) {
                    k._slide("next");
                    return false
                }
        ...
        _initEvents: function() {
            ...
            this.$el.on(this.transEndEventName,
                function() {
                    k._onEndTransition()
                }
            );
        ...
        _slide: function(l,
            ...
            if (n === e) {
                ...
                p > 0 ? this._toggleControls("prev",
                    true) : this._toggleControls("prev",
                    false);
                Math.max(o,
                    m) - m > p ? this._toggleControls("next",
                    true) : this._toggleControls("next",
                    false)
            }
            this.translation = n;
            if (k === n) {
...
$special = $event.special.debouncedresize = {
    ...
    handler: function(e,
        ...
        a ? b() : resizeTimeout = setTimeout(b,
            $special.threshold)
    },
    threshold: 250
};
            ...
            update: function(L) {
                ...
                if (typeof G.items[y] === "undefined") {} else {
                    ...
                    if (glarge.length == gthumbs.length && glarge.length > 0) {
                        ...
                        N.append(i).find(".related_photo").bind("click",
                            function() {
